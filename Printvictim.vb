...
Public Class Printvictim
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        Dim command As New SqlCommand("select * from Victimreport where Vno = @Vno", connection)



        command.Parameters.Add("@Vno", SqlDbType.Int).Value = SmallTextBox1.Text
    ...
    Private Sub Printvictim_Load(sender As Object, e As EventArgs) Handles MyBase.Load
