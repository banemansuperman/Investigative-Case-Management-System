...
Public Class Printforensic
    ...
    Private Sub Printforensic_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        command.Parameters.Add("@Fno", SqlDbType.Int).Value = SmallTextBox1.Text
