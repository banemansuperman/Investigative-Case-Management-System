...
Public Class Printsuspect
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PictureBox2.Click
        ...
        command.Parameters.Add("@Id", SqlDbType.Int).Value = SmallTextBox1.Text
        ...
        Try
            ...
            TextBox3.Text = "" 'date
            TextBox2.Text = "" 'sid
            TextBox5.Text = "" 'suspectde
            TextBox6.Text = "" 'loca

            TextBox4.Text = "" 'vname
            TextBox8.Text = "" 'witnessdesc
    ...
    Private Sub Printsuspect_Load(sender As Object, e As EventArgs) Handles MyBase.Load
